...
playerSprites.up[0].src    = 'assets/images/players/player-up-1.png';
playerSprites.up[1].src    = 'assets/images/players/player-up-2.png';
playerSprites.down[0].src  = 'assets/images/players/player-down-1.png';
playerSprites.down[1].src  = 'assets/images/players/player-down-2.png';
// Left-facing art is not in the project yet, so reuse the right-facing frames
// instead of loading missing files and breaking the sprite draw.
playerSprites.left[0].src  = 'assets/images/players/player-right-1.png';
playerSprites.left[1].src  = 'assets/images/players/player-right-2.png';
playerSprites.right[0].src = 'assets/images/players/player-right-1.png';
playerSprites.right[1].src = 'assets/images/players/player-right-2.png';

// Snack Hunt background — preloaded once, drawn on canvas each frame
const snackHuntBgImg = new Image();
snackHuntBgImg.src = 'assets/images/backgrounds/snack-hunt-bg.png';
...
snackSprites.chips[0].src   = 'assets/images/snacks/snack-chips-1.png';
snackSprites.chips[1].src   = 'assets/images/snacks/snack-chips-2.png';
snackSprites.candy[0].src   = 'assets/images/snacks/snack-candy-1.png';
snackSprites.candy[1].src   = 'assets/images/snacks/snack-candy-2.png';
snackSprites.burrito[0].src = 'assets/images/snacks/snack-burrito-1.png';
snackSprites.burrito[1].src = 'assets/images/snacks/snack-burrito-2.png';
const junkBossSprites = [
  { normal: [new Image(), new Image()], hit: new Image() },
  { normal: [new Image(), new Image()], hit: new Image() },
  { normal: [new Image(), new Image()], hit: new Image() },
];
junkBossSprites[0].normal[0].src = 'assets/images/junk/junk-1-1.png';
junkBossSprites[0].normal[1].src = 'assets/images/junk/junk-1-2.png';
junkBossSprites[0].hit.src       = 'assets/images/junk/junk-1-hit.png';
junkBossSprites[1].normal[0].src = 'assets/images/junk/junk-2-1.png';
junkBossSprites[1].normal[1].src = 'assets/images/junk/junk-2-2.png';
junkBossSprites[1].hit.src       = 'assets/images/junk/junk-2-hit.png';
junkBossSprites[2].normal[0].src = 'assets/images/junk/junk-3-1.png';
junkBossSprites[2].normal[1].src = 'assets/images/junk/junk-3-2.png';
junkBossSprites[2].hit.src       = 'assets/images/junk/junk-3-hit.png';
...
trafficPlayerSprites[0].src = 'assets/images/traffic/traffic-player-1.png';
trafficPlayerSprites[1].src = 'assets/images/traffic/traffic-player-2.png';

// Background
const trafficBgImg = new Image();
trafficBgImg.src = 'assets/images/backgrounds/traffic-bg.png';
...
for (let i = 0; i < TRAFFIC_CAR_TYPE_COUNT; i++) {
  trafficCarSprites[i][0].src = `assets/images/traffic/traffic-car-${i + 1}-1.png`;
  trafficCarSprites[i][1].src = `assets/images/traffic/traffic-car-${i + 1}-2.png`;
}
